      ...
      {isOpen && (
        <>
          ...
          <motion.div 
            ...
            className="fixed bottom-0 left-0 right-0 bg-white h-[80vh] rounded-t-[3rem] shadow-[0_-8px_30px_rgb(0,0,0,0.1)] p-8 flex flex-col border-t border-gray-100 z-[60]"
          >
            <div className="flex items-center justify-between mb-6 px-2">
              <div className="space-y-1">
                <h1 className="text-xl font-black text-gray-900 tracking-tight">Add New Trip</h1>
                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Quick Log Entry</p>
              </div>
              <button 
                onClick={onClose}
